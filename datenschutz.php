...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# place: http://ogp.me/ns/place#">
    ...
    <meta charset="UTF-8">
    <title>Biltec AG  | Datenschutz</title>
...
<body>
    <section class="datenschutz main">
        <h1 class="big">Datenschutzerklärung</h1>
        <p>
            Mit dieser Datenschutzerklärung informieren wir, welche Personendaten wir im Zusammenhang mit unseren Aktivitäten und Tätigkeiten einschliesslich unserer <a href="https://www.biltec.ch">www.biltec.ch</a> Website bearbeiten. Wir informieren insbesondere, wofür, wie und wo wir welche Personendaten bearbeiten. Wir informieren ausserdem über die Rechte von Personen, deren Daten wir bearbeiten.
        </p>
        <p>
        ...
        <h4>5.1 Datenschutzrechtliche Ansprüche</h4>
        <p>
        ...
        <h4>5.2 Recht auf Beschwerde</h4>
        <p>
        ...
        <h4>8.1 Digitale Infrastruktur</h4>
        <p>
        ...
        <p>
            Wir nutzen insbesondere: <br>
            <a href="https://www.myfonts.com/de/a/font/legal/website-use-privacy-policy">Dienste von My Fonts</a><br>
        </p>
